...
class PatientReport(TimeStampedModel):
    ...
    lab_report = models.ForeignKey(LabReport, on_delete=models.CASCADE, related_name='patient_reports', null=True, blank=True)
...
class ReportSection(TimeStampedModel):
    ...
    report = models.ForeignKey(PatientReport, on_delete=models.CASCADE, related_name='sections')
...
class ReportQuestion(TimeStampedModel):
    ...
    report = models.ForeignKey(PatientReport, on_delete=models.CASCADE, related_name='questions')
...
class ReportRecommendation(TimeStampedModel):
    ...
    public_id = models.CharField(max_length=80, db_index=True)
    report = models.ForeignKey(PatientReport, on_delete=models.CASCADE, related_name='recommendations')
    title = models.CharField(max_length=200)
    text = models.TextField()
...
class ReportSource(TimeStampedModel):
    ...
    public_id = models.CharField(max_length=80, db_index=True)
    report = models.ForeignKey(PatientReport, on_delete=models.CASCADE, related_name='sources')
